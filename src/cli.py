...
def main_action(        
    ...
    multi_candidate: bool = typer.Option(True, "--multi-candidate/--no-multi-candidate", help="Enable multi-candidate (max-coverage) runs; pass --no-multi-candidate to disable.")
):
    """
    ...
    inspect_library(
        ...
        run_all_candidates=multi_candidate,
    )
